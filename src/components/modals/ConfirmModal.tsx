        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex justify-center gap-3 pt-4">
            ...
            <button
              ...
              disabled={loading}
              className="px-6 py-2.5 bg-black text-white rounded-lg hover:bg-gray-800 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {loading && (
