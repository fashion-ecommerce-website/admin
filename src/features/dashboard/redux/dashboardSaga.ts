 ...
 */
function* handleFetchDashboard(action: PayloadAction<'day' | 'week' | 'month' | 'year'>): Generator<Effect, void, DashboardResponse> {
  try {
 ...
 */
function* handleFetchStats(): Generator<Effect, void, never> {
  try {
